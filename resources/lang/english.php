...
$_LANG['gandiadmin']['registertemplate'] = "Template - Registration";
$_LANG['gandiadmin']['transfertemplate'] = "Template - Transfer";
...
$_LANG['x-gandi-acks-description'] = '<span>I understand that <a target="_blank" href="https://hosterra.eu">Hosterra SAS</a> acts as a <a target="_blank" href="https://gandi.net">Gandi SAS</a> domain reseller. Nevertheless, I understand that under the terms of the contract agreed between the two parties, <a target="_blank" href="https://hosterra.eu">Hosterra SAS</a> remains my sole contact regarding the management of domains registered or transferred to Hosterra.</span>';
$_LANG['x-gandi-terms'] = "Terms & conditions";
$_LANG['x-gandi-terms-description'] = '<span>I confirm that I have read, understood and I agree to:<ul><li>the Hosterra <a target="_blank" href="https://hosterra.eu">domains terms and conditions</a>;</li><li>the domains name registration <a target="_blank" href="https://www.gandi.net/en/contracts/tlds">special conditions</a> that may apply to this domain.</li></ul></span>';
